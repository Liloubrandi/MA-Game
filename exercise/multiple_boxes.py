...
block_group.add(Block(BLOCK_WIDTH, BLOCK_HEIGHT, (0, 255, 0), x = 2 * BLOCK_WIDTH, y = -BLOCK_HEIGHT))
block_group.add(Block(BLOCK_WIDTH, BLOCK_HEIGHT, (0, 0, 255), x = 4 * BLOCK_WIDTH, y = -2 * BLOCK_HEIGHT))
