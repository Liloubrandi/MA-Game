...
class Block(pygame.sprite.Sprite):
    def __init__(self, width, height, color=(255, 0, 0), x=0, y=0):
        super().__init__()
...
class LShape(pygame.sprite.Group):
    def __init__(self) -> None:
        super().__init__()
        self.add(Block(BLOCK_WIDTH, BLOCK_HEIGHT, x=0, y=0))
        self.add(Block(BLOCK_WIDTH, BLOCK_HEIGHT, y=BLOCK_HEIGHT))
        self.add(Block(BLOCK_WIDTH, BLOCK_HEIGHT, y=2*BLOCK_HEIGHT))
        self.add(Block(BLOCK_WIDTH, BLOCK_HEIGHT, x=BLOCK_WIDTH, y=2*BLOCK_HEIGHT))
